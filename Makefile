...
test-vagrant:
	...
	testinfra --hosts=statsd_trusty --ssh-config=.vagrant/ssh-config --noconftest --sudo
	testinfra --hosts=statsd_xenial --ssh-config=.vagrant/ssh-config --noconftest --sudo
